...
def test_shift_types_single() -> None:
    shift1 = Shift(ShiftType.T, 1, 60, [])
    shift2 = Shift(ShiftType.T, 2, 80, [])
    course = Course('J301N1', 1, [shift1, shift2])

    assert course.shift_types == {ShiftType.T}

def test_shift_types_multiple() -> None:
    shift1 = Shift(ShiftType.T, 1, 60, [])
    shift2 = Shift(ShiftType.PL, 2, 80, [])
    course = Course('J301N1', 1, [shift1, shift2])

    assert course.shift_types == {ShiftType.T, ShiftType.PL}
