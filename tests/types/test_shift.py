...
def test_init_single_timeslot() -> None:
    ...
    for shift_timeslot in shift.timeslots:
        assert shift_timeslot is timeslot
...
def test_init_multiple_compatible_timeslots() -> None:
    ...
    for shift_timeslot in shift.timeslots:
        assert shift_timeslot is timeslot1 or shift_timeslot is timeslot2
...
def test_eq_same_timeslots() -> None:
    ...
    shift1 = Shift(ShiftType.T, 1, 130, [timeslot1, timeslot2])
    shift2 = Shift(ShiftType.T, 1, 130, [timeslot2, timeslot1])
    assert shift1 == shift2
